...
void matMulHost(_DOUBLE_ *C, const _DOUBLE_ *A, const _DOUBLE_ *B, unsigned int M, unsigned int N)
{
...
void reference_dgemm(unsigned int N, _DOUBLE_ Alpha, _DOUBLE_ *A, _DOUBLE_ *B, _DOUBLE_ *C)
{
